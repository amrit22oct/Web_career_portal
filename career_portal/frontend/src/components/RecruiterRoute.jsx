...
const RecruiterDashboard = () => {
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      setError("There was an issue fetching jobs. Please try again later.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDeleteJob = async (jobId) => {
    ...
    try {
      ...
      setError("There was an issue deleting the job. Please try again later.");
    }
  };

  // Initialize user and jobs fetching
  useEffect(() => {
